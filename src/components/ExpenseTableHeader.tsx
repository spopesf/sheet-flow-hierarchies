  ...
  return (
    <thead>
      <tr className="border-b border-slate-100 bg-slate-50">
        ...
        <th className="text-right py-2 px-2 font-medium text-xs text-slate-600 tracking-wide min-w-[70px] align-bottom">Freight to Store Expense</th>
        ...
        <th className="text-right py-2 px-2 font-medium text-xs text-slate-600 tracking-wide min-w-[60px] align-bottom">Avg. Freight to Store Expense</th>
